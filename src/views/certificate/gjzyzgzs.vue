<template>
	<div style="margin: 20px;">
		<a-card title="国家职业资格证书查询" style="min-height: calc(100vh - 160px);overflow: hidden;">
			...
			<div class="headers">
				...
				<!-- <a-button type="primary" class="btn" icon="folder-open" @click="dc">批量导出</a-button> -->
				<download-excel class="export-excel-wrapper" :data="json_data" :fields="json_fields" name="国家职业资格证书.xls">
		...
		<a-modal class="dr" title="批量导入" :visible="visible2" :footer="null" centered :width="500" @cancel="visible2 = false">
			<div class="list">
				...
				<div><a style="margin-left: 10px;" @click="downMb">下载模板</a></div>
			</div>
...
export default {
	...
	methods: {
		...
		async search() {
			...
			const data = await zscxHttp.gjzyzgzs(parme);
